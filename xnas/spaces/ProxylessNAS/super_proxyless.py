...
import copy
from xnas.spaces.ProxylessNAS.layers import *

from xnas.spaces.ProxylessNAS import make_divisible
from xnas.spaces.ProxylessNAS.cnn import ProxylessNASNet
from xnas.spaces.ProxylessNAS.layers import ConvLayer
from xnas.spaces.ProxylessNAS.mix_op import MixedEdge, build_candidate_ops
from xnas.spaces.ProxylessNAS.proxyless_nets import MobileInvertedResidualBlock, ProxylessNASNets
...
class SuperProxylessNASNets(ProxylessNASNets):
    ...
    def expected_latency(self, latency_model):
        expected_latency = 0
        # first conv
        ...
        while not queue.empty():
            ...
            for m in module._modules:
                ...
                if child.__str__().startswith('MixedEdge'):
                    ...
                    queue.put(child)
        return ProxylessNASNet(self.first_conv, list(self.blocks), self.feature_mix_layer, self.classifier)
...
def _SuperProxylessNASNets():
    from xnas.core.config import cfg
    
    return SuperProxylessNASNets(
        width_stages=[24, 40, 80, 96, 192, 320],
        n_cell_stages=[4, 4, 4, 4, 4, 1],
        conv_candidates=['3x3_MBConv3', '3x3_MBConv6', '5x5_MBConv3', '5x5_MBConv6', '7x7_MBConv3', '7x7_MBConv6'],
