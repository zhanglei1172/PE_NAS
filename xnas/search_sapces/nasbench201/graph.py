...
from xnas.core.graph import Graph
from xnas.core import primitives as ops
from xnas.core.query_metrics import Metric
from xnas.search_sapces.nasbench201.conversions import convert_op_indices_to_xnas, convert_xnas_to_op_indices, convert_xnas_to_str

# from xnas.search_spaces.core import primitives as ops
# from xnas.search_spaces.core.graph import Graph, EdgeData
# from xnas.search_spaces.core.primitives import AbstractPrimitive
# from xnas.search_spaces.core.query_metrics import Metric
# from xnas.search_spaces.nasbench201.conversions import (
#     convert_op_indices_to_xnas,
#     convert_xnas_to_op_indices,
#     convert_xnas_to_str,
# )

# from xnas.utils.utils import get_project_root
...
class NasBench201SearchSpace(Graph):
    ...
    def query(
        ...
        arch_str = convert_xnas_to_str(self)
    ...
    def get_op_indices(self):
        if self.op_indices is None:
            self.op_indices = convert_xnas_to_op_indices(self)
    ...
    def set_op_indices(self, op_indices):
        # This will update the edges in the xnas object to op_indices
        self.op_indices = op_indices
        convert_op_indices_to_xnas(op_indices, self)
    ...
    def mutate(self, parent, dataset_api=None):
        ...
        update the xnas object and op_indices
        """
