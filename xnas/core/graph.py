...
from xnas.core.utils import AttrDict, iter_flatten
from xnas.logger.logging import log_formats

# from xnas.utils.utils import iter_flatten, AttrDict
# from xnas.utils.logging import log_formats, log_first_n
    ...
    def forward(self, x, *args):
        ...
        for node_idx in lexicographical_topological_sort(self):
            ...
            if ("subgraph" in node and "comb_op" not in node) or (
                ...
                logger.warning("Comb_op is ignored if subgraph is defined!")
                ...
                for neigbor_idx in self.neighbors(node_idx):
                    ...
                    if isinstance(edge_data.op, Graph):
                        ...
                        # case for the nb101 graph
                                        ...
                                        xnas.search_spaces.nasbench101.primitives.ModelWrapper):
