...
from xnas.spaces.Transbench101.cnn import _SPOS_trans101_micro_CNN, _infer_trans101_macro_CNN, _infer_trans101_micro_CNN
from xnas.spaces.NASBench1Shot1.cnn import _NASbench1shot1_1,_NASbench1shot1_2, _NASbench1shot1_3
# from xnas.search_sapces.nasbench201.graph import NasBench201SearchSpace
...
SUPPORTED_SPACES = {
    ...
    "transbench101_micro": _SPOS_trans101_micro_CNN,
    "pdarts": _PDartsCNN,
    "pcdarts": _PCDartsCNN,
...
# def arch_space_builder(**kwargs):
#     err_str = "space type '{}' not supported".format(cfg.ARCH_SPACE.NAME)
#     assert cfg.ARCH_SPACE.NAME in SUPPORTED_ARCH_SPACES.keys(), err_str
#     return SUPPORTED_ARCH_SPACES[cfg.ARCH_SPACE.NAME](**kwargs)
